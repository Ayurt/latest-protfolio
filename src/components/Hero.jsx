      ...
      <div className='flex flex-wrap'>
        <div className='w-full lg:w-1/2'>
          <div className='flex flex-col items-center lg:items-start'>
            <motion.h1 variants={container(0.5)} initial='hidden' animate="visible" className='pb-16 text-6xl font-thin tracking-tight lg:mt-16 lg:text-6xl'>
              Abhishek Samari
            </motion.h1>
            ...
            <motion.p variants={container(1.5)} initial='hidden' animate="visible" className='my-2 max-w-xl py-6 font-light tracking-tight'>
              {HERO_CONTENT}
            </motion.p>
          </div>
        </div>
